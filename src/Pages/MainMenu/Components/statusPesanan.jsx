  ...
  const steps = [
    {
      ...
      description: "Atas : nama Ara - Meja no 26",
      time: "11.05",
    },
    {
    ...
    },
    {
      ...
      description: "Melalui QR Code, Atas : nama Ara - Meja no 26",
      time: "08.05",
    },
    {
        ...
        {steps.map((step, index) => (
          <Step key={index}>
            ...
            <Box flexShrink="0">
              ...
              <StepDescription>
                <Text fontSize="10px">{step.description}</Text>
              </StepDescription>
            </Box>
